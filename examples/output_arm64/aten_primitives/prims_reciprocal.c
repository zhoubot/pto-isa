...
// ======================================================================
// TILE BUFFER ANALYSIS: prims_reciprocal
// ======================================================================
//
// SUMMARY:
...
void prims_reciprocal(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
    float x[1][4096];
    float result[1][4096];
...
#include <stddef.h>
const char* pto_program_name() { return "prims_reciprocal"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    prims_reciprocal((float*)args[0], (float*)args[1], (int32_t)0, (int32_t)0);
}
