...
// ======================================================================
// TILE BUFFER ANALYSIS: aten_add_scalar
// ======================================================================
//
// SUMMARY:
...
void aten_add_scalar(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
    float x[1][4096];
    float result[1][4096];
...
#include <stddef.h>
const char* pto_program_name() { return "aten_add_scalar"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    aten_add_scalar((float*)args[0], (float*)args[1], (int32_t)0, (int32_t)0);
}
