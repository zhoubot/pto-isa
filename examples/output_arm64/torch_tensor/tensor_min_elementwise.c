...
// ======================================================================
// TILE BUFFER ANALYSIS: tensor_min_elementwise
// ======================================================================
//
// SUMMARY:
...
#include <stddef.h>
const char* pto_program_name() { return "tensor_min_elementwise"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    tensor_min_elementwise((float*)args[0], (float*)args[1], (float*)args[2]);
}
