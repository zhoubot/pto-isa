...
PTO_INTERNAL void TCOLEXPANDMAX_IMPL(TileData &dst, TileData &src0, TileDataSrc &src1)
{
    static_assert(
    ...
    TColExpandMax<TileData, TileDataSrc, elementsPerRepeat, blockSizeElem, rowStride>(dst.data(), src0.data(),
