...
#include <stddef.h>
const char* pto_program_name() { return "attention_relative_position"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    attention_relative_position((float*)args[0], (float*)args[1], (float*)args[2], (float*)args[3], (float*)args[4]);
}
