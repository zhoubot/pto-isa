...
// ======================================================================
// TILE BUFFER ANALYSIS: document_attention
// ======================================================================
//
// SUMMARY:
...
//   shifted              8x8        f32       256   [  9,  10]           <- doc_mask
//
// BUFFER REUSE MAP:
//   masked_scores reuses buffer of scores
//   shifted reuses buffer of doc_mask
...
#include <stddef.h>
const char* pto_program_name() { return "document_attention"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    document_attention((float*)args[0], (float*)args[1], (float*)args[2], (float*)args[3], (float*)args[4]);
}
