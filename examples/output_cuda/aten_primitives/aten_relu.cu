...
// ======================================================================
// TILE BUFFER ANALYSIS: aten_relu
// ======================================================================
//
// SUMMARY:
...
__global__ void aten_relu_kernel(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
...
void aten_relu(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
    dim3 block(8, 8);
    dim3 grid(1, 1);
