...
// ======================================================================
// TILE BUFFER ANALYSIS: aten_mul_scalar
// ======================================================================
//
// SUMMARY:
...
__global__ void aten_mul_scalar_kernel(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
...
void aten_mul_scalar(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
    dim3 block(8, 8);
    dim3 grid(1, 1);
