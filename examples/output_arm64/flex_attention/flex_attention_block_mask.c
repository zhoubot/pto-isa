...
// ======================================================================
// TILE BUFFER ANALYSIS: flex_attention_block_mask
// ======================================================================
//
// SUMMARY:
...
//   shifted              8x8        f32       256   [  9,  10]           <- block_mask
//
// BUFFER REUSE MAP:
//   masked_scores reuses buffer of scores
//   shifted reuses buffer of block_mask
...
#include <stddef.h>
const char* pto_program_name() { return "flex_attention_block_mask"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    flex_attention_block_mask((float*)args[0], (float*)args[1], (float*)args[2], (float*)args[3], (float*)args[4]);
}
