// PTO Program: op_rowmax
// Function Type: InCore (tile-level computation)
// ======================================================================
// TILE BUFFER ANALYSIS: op_rowmax
// ======================================================================
//
// SUMMARY:
...
void op_rowmax(float* input, float* output) {
    float x[128][128];
    float y[128][1];
...
#include <stddef.h>
const char* pto_program_name() { return "op_rowmax"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    op_rowmax((float*)args[0], (float*)args[1]);
}
