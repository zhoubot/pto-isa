...
void op_max(float* input0, float* input1, float* output) {
    float a[128][128];
    float b[128][128];
    float y[128][128];
    ...
    // FUSED LOOP (4 ops): a=TLOAD(input0,0,0); b=TLOAD(input1,0,0); y=TMAX(a,b); output=TSTORE(y,0,0)
...
#include <stddef.h>
const char* pto_program_name() { return "op_max"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    op_max((float*)args[0], (float*)args[1], (float*)args[2]);
}
