// PTO Program: op_colsum
// Function Type: InCore (tile-level computation)
// ======================================================================
// TILE BUFFER ANALYSIS: op_colsum
// ======================================================================
//
// SUMMARY:
...
void op_colsum(float* input, float* output) {
    float x[128][128];
    float y[1][128];
...
#include <stddef.h>
const char* pto_program_name() { return "op_colsum"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    op_colsum((float*)args[0], (float*)args[1]);
}
