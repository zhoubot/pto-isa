// PTO Program: op_rowmin
// Function Type: InCore (tile-level computation)
// ======================================================================
// TILE BUFFER ANALYSIS: op_rowmin
// ======================================================================
//
// SUMMARY:
...
void op_rowmin(float* input, float* output) {
    float x[128][128];
    float y[128][1];
...
#include <stddef.h>
const char* pto_program_name() { return "op_rowmin"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    op_rowmin((float*)args[0], (float*)args[1]);
}
