...
// ======================================================================
// TILE BUFFER ANALYSIS: prims_maximum
// ======================================================================
//
// SUMMARY:
...
__global__ void prims_maximum_kernel(float* input_x, float* input_y, float* output, int32_t num_full_tiles, int32_t tail_elements) {
...
void prims_maximum(float* input_x, float* input_y, float* output, int32_t num_full_tiles, int32_t tail_elements) {
    dim3 block(8, 8);
    dim3 grid(1, 1);
