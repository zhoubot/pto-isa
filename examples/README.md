...
├── cpu/              # CPU simulation examples (cross-platform)
│   ├── gemm_demo/
...
> Note: PTODSL + PTOAS CPU end-to-end examples live in `examples/ptodsl_ptoas_cpu/` (not under `examples/`).
