...
// ======================================================================
// TILE BUFFER ANALYSIS: prims_neg
// ======================================================================
//
// SUMMARY:
...
__global__ void prims_neg_kernel(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
...
void prims_neg(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
    dim3 block(8, 8);
    dim3 grid(1, 1);
