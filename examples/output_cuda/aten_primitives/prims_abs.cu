...
// ======================================================================
// TILE BUFFER ANALYSIS: prims_abs
// ======================================================================
//
// SUMMARY:
...
__global__ void prims_abs_kernel(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
...
void prims_abs(float* input, float* output, int32_t num_full_tiles, int32_t tail_elements) {
    dim3 block(8, 8);
    dim3 grid(1, 1);
