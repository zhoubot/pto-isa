// PTO Program: op_recip
// Function Type: InCore (tile-level computation)
// ======================================================================
// TILE BUFFER ANALYSIS: op_recip
// ======================================================================
//
// SUMMARY:
...
void op_recip(float* input, float* output) {
    float x[128][128];
    float y[128][128];

    // Loop fusion: 2 loop overheads saved

    // FUSED LOOP (3 ops): x=TLOAD(input,0,0); y=TRECIP(x); output=TSTORE(y,0,0)
...
#include <stddef.h>
const char* pto_program_name() { return "op_recip"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    op_recip((float*)args[0], (float*)args[1]);
}
