...
// ======================================================================
// TILE BUFFER ANALYSIS: tensor_cosh
// ======================================================================
//
// SUMMARY:
...
//   sum_val              8x8        f32       256   [  4,   5]           <- neg_x
//   x                    8x8        f32       256   [  0,   2]           -
//
// BUFFER REUSE MAP:
//   exp_neg_x reuses buffer of x
//   sum_val reuses buffer of neg_x
...
#include <stddef.h>
const char* pto_program_name() { return "tensor_cosh"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    tensor_cosh((float*)args[0], (float*)args[1]);
}
